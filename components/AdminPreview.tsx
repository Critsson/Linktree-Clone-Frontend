...
const AdminPreview = (props: props) => {
    ...
    return (
        <div style={{
            ...
            <iframe key={props.iframeUpdateCount} scrolling="no" style={{height: "100%", width: "100%", borderRadius: "3vw", borderColor: "transparent"}} src={`https://chainlink.chrisgao.dev/${props.username}`} title="Preview Screen"></iframe>
